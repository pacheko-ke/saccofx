...
function TextInput({
    ...
    return (
        <input
            ...
            className={`w-full rounded-[3px] border border-[#D8CFBA] bg-[#FFFDF8] px-3 py-2 text-[14px] text-[#14231E] placeholder:text-[#A9B5AE] focus:border-[#B98A3D] focus:outline-none focus:ring-2 focus:ring-[#B98A3D]/25 ${mono ? "font-mono" : ""
                }`}
        />
    );
}
